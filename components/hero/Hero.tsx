  ...
  return (
    <div className="flex flex-col select-none">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 3xs:mx-[-50px] md:mx-auto">
            <div>
                <h1 className="4xs:text-[36px] sm:text-4xl font-semibold">Hello, I&apos;m Raz</h1>
                <TextEffect />
        ...
        <section className="relative mt-20">
            <div className="w-[95%] mx-auto">
                {topFeature.map((post, index) => (
                    ...
                    >
                        <span className={post.tags.includes('Frontend') ? 'bg-pink-800 text-white py-2 w-[50%] flex items-center justify-center rounded-lg' : ''}>{post.tags}</span>
