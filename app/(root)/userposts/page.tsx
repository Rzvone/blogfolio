...
const UserPosts = async () => {
  ...
  return (
    <div className="min-h-[86vh] w-full mt-10">
      {!user ? (
        <h1 className="text-center text-6xl font-semibold">Sign in to view posts</h1>
      ) : (
        <div className="max-w-[90%] mx-auto">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 4xs:grid-cols-1 justify-center items-center gap-10">
            {posts.map((p) => (
